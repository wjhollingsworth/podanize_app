...
class NewslettersControllerTest < ActionController::TestCase
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post :create, newsletter: { description: @newsletter.description, name: @newsletter.name, user_id: @newsletter.user_id }
    end
  ...
  test "should update newsletter" do
    patch :update, id: @newsletter, newsletter: { description: @newsletter.description, name: @newsletter.name, user_id: @newsletter.user_id }
    assert_redirected_to newsletter_path(assigns(:newsletter))
  end
